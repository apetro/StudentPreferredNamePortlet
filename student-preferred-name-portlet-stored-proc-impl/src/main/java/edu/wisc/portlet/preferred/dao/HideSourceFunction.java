...
public class HideSourceFunction extends StoredProcedure {
    private static final String SQL = "msnprefname.HIDE_SOURCE_NAME";
    private static final String PVI = "P_PVI_I";
    protected static final String FUNC_RETURN = "returnname";
    private static final String SUCCESS = "Success";

    public HideSourceFunction(DataSource dataSource) {
    ...
    public boolean hideSource(String pvi) {
